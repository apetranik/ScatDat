...
<%
  ...
  String sort_temp = request.getParameter("sort");
  Database db = new Database();
  DecimalFormat df = new DecimalFormat("#0.0");
  int num = Integer.parseInt(number);
  int sort = Integer.parseInt(sort_temp);
  
  session.setAttribute("sortStyle", sort);
  int order = (int)session.getAttribute("orderStyle");
