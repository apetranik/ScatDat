...
CREATE TABLE `wishlist` (
  ...
  CONSTRAINT `wishlist_ibfk_2` FOREIGN KEY (`courseID`) REFERENCES `course` (`courseID`)
...
INSERT INTO `wishlist` VALUES (1,40105,1),(1,39995,2),(2,39821,3),(3,37001,4),(1,40109,5);
